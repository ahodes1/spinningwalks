...
function preload() {
  ...
  song2 = loadSound('assets/Madeleineaudio.mp3');
  song3 = loadSound('assets/Margotaudio.mp3');
  //song4 = loadSound('assets/zoeaudio.mp3');
...
function setup() {
 ...
 // vid3.position(0, 384);
  ...
  button1.mousePressed(enterVideo1);
  ...
  button4.mousePressed(enterVideo4);
...
function enterVideo1() {
  
  vid1 = createVideo(['assets/MadeleineVideoSmall.mp4'], vid1Load);
  vid1.position(0, 0);
  vid1.size(690, 384);
...
function enterVideo4() {
  
  vid4 = createVideo(['assets/MargotMapSmall.mp4'], vid4Load);
