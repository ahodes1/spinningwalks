...
function setup() {
  createCanvas(displayWidth, displayHeight);  //ORIGINALLY 1620, 861 //1400, 628
 ...
 // marginpop.position(1100, 0);
  ...
  fill(250, 250, 250);
  border1 = createDiv('');
  border1.style('width', '675px');
  border1.style('height', '380px');
  border1.position(-8, -370);
  border1.style('border', '6px solid black');
  border1.parent(button1);
  border1.mouseOver(highlight);
  border1.mouseOut(unhighlight);
  
  border2 = createDiv('');
  border2.style('width', '675px');
  border2.style('height', '375px');
  border2.position(-8, -365);
  border2.style('border', '6px solid black');
  border2.parent(button3);
  border2.mouseOver(highlight);
  border2.mouseOut(unhighlight);
  
  border3 = createDiv('');
  border3.style('width', '685px');
  border3.style('height', '380px');
  border3.position(-8, -370);
  border3.style('border', '6px solid black');
  border3.parent(button2);
  border3.mouseOver(highlight);
  border3.mouseOut(unhighlight);
  
  border4 = createDiv('');
  border4.style('width', '685px');
  border4.style('height', '375px');
  border4.position(-8, -365);
  border4.style('border', '6px solid black');
  border4.parent(button4);
  border4.mouseOver(highlight);
  border4.mouseOut(unhighlight);
  ...
  expeributton.size(60,30);
  expeributton.position(1300, 780);
  expeributton.mouseOver(artiststate);
  expeributton.mouseOut(noartiststate);
